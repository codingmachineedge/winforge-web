...
const enAll = { ...en, ...enB, ...enShellNav, ...enShellFeedback, ...enShellTheme, ...enShellA11y, ...enShellSettings, ...enReactorUi, ...enReactorFuel, ...enReactorCredits };
const yueAll = { ...zhHant, ...yueB, ...yueShellNav, ...yueShellFeedback, ...yueShellTheme, ...yueShellA11y, ...yueShellSettings, ...yueReactorUi, ...yueReactorFuel, ...yueReactorCredits };
